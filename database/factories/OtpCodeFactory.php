...
class OtpCodeFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'sent_at' => now(),
            'expires_at' => now()->addMinutes(app(OtpSettings::class)->ttl_minutes),
            'attempts' => 0,
            'consumed_at' => null,
            'locked_until' => null,
    ...
    {
        return $this->state(fn (): array => [
            'attempts' => app(OtpSettings::class)->max_attempts,
            'consumed_at' => now(),
            'locked_until' => now()->addMinutes(app(OtpSettings::class)->lock_minutes),
        ]);
    }
}
