...
return [
    ...
    'vehicles' => [
        ...
        'assigned' => 'Affectés',
        'unassigned' => 'Sans conducteur',
        'inactive' => 'Hors parc',
        'all' => 'Tout le parc',
        'search_placeholder' => 'Rechercher une plaque, un modèle, un chauffeur…',
        'column_vehicle' => 'Véhicule',
        'column_plate' => 'Plaque',
        'column_driver' => 'Chauffeur',
        'column_yango_id' => 'ID Yango',
        'column_sync' => 'Synchro',
        'no_driver' => 'Aucun conducteur affecté',
        'unknown_model' => 'Modèle non renseigné',
        'none_found' => 'Aucun véhicule',
        'none_found_hint' => 'Aucun véhicule ne correspond à cette recherche. Le parc est alimenté par la synchronisation Yango.',
        'reset_filters' => 'Réinitialiser',
        'back_to_list' => 'Retour au parc',
        'identity_title' => 'Identité',
        'identity_hint' => 'Renseignée par Yango, non modifiable ici.',
        'assignment_title' => 'Affectation',
        'assignment_hint' => "L'affectation appartient à Yango : elle se change dans le parc Yango, pas ici.",
        'brand' => 'Marque',
        'model' => 'Modèle',
        'color' => 'Couleur',
        'catalogue_model' => 'Modèle au catalogue',
        'catalogue_model_hint' => 'Sert à ne proposer que les pièces compatibles.',
        'catalogue_model_missing' => 'Non rapproché du catalogue',
        'status_active' => 'Actif',
        'status_inactive' => 'Hors parc',
        'never_synced' => 'Jamais synchronisé',
        'synced_at' => 'Synchronisé :when',
    ...
    'yango_sync' => [
        ...
        'rebuild_activity' => 'Recompter le tableau de bord',
        'rebuild_activity_hint' => 'Recompte le cumul journalier à partir des courses déjà en base, sans rien redemander à Yango. À cocher seul quand « Terminées » est plein et « Tableau de bord » creux.',
        ...
        'runs_title' => 'Passes lancées',
        'runs_hint' => 'Ce que vos relances sont devenues. Une passe en file ou en cours se rafraîchit toute seule — inutile de recliquer, un second clic sur la même journée est ignoré.',
        'column_kind' => 'Nature',
        'column_status' => 'État',
        'column_launched_by' => 'Lancée par',
        'column_result' => 'Résultat',
        'launched_by_schedule' => 'Planificateur',

        'coverage_title' => 'Ce que la base porte déjà',
        'coverage_hint' => 'Journée par journée, sur la période choisie. Une journée à zéro entre deux journées pleines est le signe d\'un trou. « Tableau de bord » doit égaler « Terminées » : un écart signale un cumul non recompté.',
        'column_day' => 'Journée',
        'column_completed' => 'Terminées',
        'column_cancelled' => 'Annulées',
        'column_activity' => 'Tableau de bord',
        'drift_hint' => 'Le cumul journalier ne correspond pas aux courses terminées. Cochez « Recompter le tableau de bord » pour cette période.',
    ...
    'drivers' => [
        ...
        'column_driver' => 'Chauffeur',
        'column_identity' => 'ID / Téléphone',
        'column_license' => 'N° de permis',
        'column_status' => 'Statut',
        'column_balance' => 'Solde Yango',
        'column_cnps' => 'CNPS',
        'no_yango_id' => 'Pas d’identifiant Yango',
        'cnps_up_to_date' => 'À jour',
        'cnps_behind' => 'Pas à jour',
        ...
        'open_requests' => 'Requête(s) ouverte(s)',

        // Panneaux d'activité de la fiche, par nature.
        'panel_requests' => 'Requêtes',
        'panel_orders' => 'Commandes boutique',
        'panel_topups' => 'Recharges Yango',
        'panel_cnps' => 'Cotisations CNPS (RSTI)',
        'see_all' => 'Tout voir',
    ...
    'shop' => [
        ...
        'kpi_active' => 'Ouvertes à la commande',
        'kpi_inactive' => 'Fermées à la commande',
        ...
        'field_photo' => 'Photo',
        'field_active' => 'Ouverte à la commande',
        'field_active_hint' => 'Décochez pour retirer la pièce du catalogue mobile sans la supprimer.',
        ...
        'carte_grise_missing' => "Aucune carte grise n'est jointe à cette commande.",
        'carte_grise_open' => 'Ouvrir la photo :number de la carte grise',
        'carte_grise_photo' => 'Photo :number',
    ...
    'campaigns' => [
        ...
        'compose_hint' => 'Le message tombe dans le fil de chaque conducteur visé, comme un message du support.',
        'step_message' => 'Le message',
        'step_message_hint' => 'Ce que le conducteur lira dans son fil.',
        'step_image' => 'Illustration et lien',
        'step_image_hint' => "Une image s'affiche au-dessus du texte.",
        'step_audience' => 'La cible',
        'step_audience_hint' => 'À qui ce message sera déposé.',
        'title_placeholder' => 'Maintenance dimanche',
        'body_placeholder' => 'Le service sera interrompu dimanche de 2 h à 4 h. Merci de votre compréhension.',
        'image_drop' => 'Glissez une image ici, ou cliquez pour choisir',
        'preview_thread' => 'Support WiGO',
        'preview_empty' => "L'aperçu s'affiche ici au fur et à mesure que vous écrivez.",
        'preview_deeplink' => "Ouvre un écran de l'application",
        'field_title' => 'Titre',
        'field_body' => 'Message',
        ...
        'draft_updated' => 'Brouillon « :title » mis à jour.',
        'edit' => 'Modifier',
        'compose_edit_title' => 'Modifier le brouillon',
        ...
        'replayed' => 'Remise relancée.',
        'replayed_count' => '{0} Aucune remise relancée|{1} :count remise relancée|[2,*] :count remises relancées',
        'not_replayable' => 'Cette remise a déjà abouti : il n\'y a rien à rejouer.',
        'confirm_replay_title' => 'Rejouer cette remise ?',
        'confirm_replay_body' => 'Le message sera de nouveau déposé dans le fil de ce conducteur, et une notification partira.',
        'confirm_replay_all_title' => 'Rejouer toutes les remises en échec ?',
        'confirm_replay_all_body' => '{0} Aucune remise à rejouer.|{1} Une remise sera relancée. Les conducteurs déjà servis ne sont pas touchés.|[2,*] :count remises seront relancées. Les conducteurs déjà servis ne sont pas touchés.',
        'filter_all' => 'Tous',
        'filter_read' => 'Lus',
    ...
    'announcements' => [
        ...
        'field_title' => 'Titre',
        'field_media' => 'Média',
        'field_duration' => 'Durée d\'affichage (secondes)',
        'field_duration_hint' => 'Temps pendant lequel la bannière reste à l\'écran avant de laisser la place à la suivante.',
    ...
    'settings' => [
        ...
        'yango_title' => 'Accès au parc Yango',
        ...
        'yango_saved' => 'Accès au parc Yango enregistré.',
        'yango_test' => 'Tester la connexion',
        'yango_testing' => 'Test en cours…',
        'yango_test_ok' => 'Connexion établie : Yango a répondu.',
        'yango_test_empty' => 'Connexion établie, mais Yango ne remonte aucun conducteur.',
        'yango_test_failed_status' => 'Échec (:status) : :message',
    ...
    'users' => [
        ...
        'search_placeholder' => 'Nom, adresse e-mail, téléphone…',
        'new_user' => 'Nouvel utilisateur',
        'manage_roles' => 'Rôles et droits',
        'back_to_users' => 'Utilisateurs',
        ...
        'state_active' => 'Actif',
        'state_inactive' => 'Désactivé',

        'empty_title' => 'Aucun utilisateur pour ces filtres.',
        'empty_hint' => 'Élargissez la recherche ou retirez un filtre.',

        'form_new_title' => 'Nouvel utilisateur',
        'form_edit_title' => "Fiche de l'utilisateur",
        'form_hint' => "Les rôles suffisent dans la plupart des cas. N'ouvrez les droits en plus que pour une exception.",
        'first_name' => 'Prénom',
        'last_name' => 'Nom',
        'email' => 'Adresse e-mail',
        'phone' => 'Téléphone',
        'is_active_label' => 'Compte actif (peut se connecter)',

        'roles_legend' => 'Rôles',
        'role_permission_count' => '{0} aucun droit|{1} 1 droit|[2,*] :count droits',
        'permissions_legend' => 'Droits en plus',
        'effective_summary' => '{0} Aucun droit|{1} 1 droit au total|[2,*] :total droits au total — :inherited par les rôles, :direct en direct',
        'via_role' => 'via :roles',

        'created' => 'Compte de :name créé.',
        'updated' => 'Compte de :name enregistré.',
        'enabled' => 'Compte de :name réactivé.',
        'disabled' => 'Compte de :name désactivé.',
        'cannot_disable_self' => 'Vous ne pouvez pas désactiver votre propre compte.',

        'disable' => 'Désactiver',
        'enable' => 'Réactiver',
        'disable_title' => 'Désactiver ce compte ?',
        'disable_body' => ':name ne pourra plus se connecter et sera déconnecté au prochain accès. Le compte et son historique sont conservés.',
        'enable_title' => 'Réactiver ce compte ?',
        'enable_body' => ':name pourra se reconnecter avec ses rôles actuels.',

        'reset_password' => 'Mot de passe',
        'reset_title' => 'Réinitialiser le mot de passe ?',
        'reset_body' => "Un mot de passe provisoire sera généré pour :name et affiché une seule fois. L'ancien cessera immédiatement de fonctionner.",
        'reset_confirm' => 'Réinitialiser',
        'password_reset' => 'Mot de passe de :name réinitialisé.',
        'password_issued_title' => 'Mot de passe provisoire',
        'password_issued_hint' => "Transmettez-le maintenant : il n'est enregistré nulle part en clair et ne pourra pas être réaffiché.",
        'password_dismiss' => "J'ai noté",

        'new_role' => 'Nouveau rôle',
        'role_user_count' => '{0} aucun titulaire|{1} 1 titulaire|[2,*] :count titulaires',
        'role_of_total' => 'sur :total',
        'access_only' => 'accès',
        'role_no_permission' => 'Aucun droit : ce rôle ne donne accès à rien.',
        'role_form_new_title' => 'Nouveau rôle',
        'role_form_edit_title' => 'Droits du rôle',
        'role_form_hint' => "Cocher une action donne l'accès au module ; retirer l'accès retire ses actions.",
        'role_label' => 'Libellé',
        'role_description' => 'Description',
        'role_permissions_legend' => '{0} Droits — aucun coché|{1} Droits — 1 coché|[2,*] Droits — :count cochés',
        'actions_need_access' => "Les actions demandent l'accès au module.",
        'role_created' => 'Rôle « :label » créé.',
        'role_updated' => 'Rôle « :label » enregistré.',
        'role_deleted' => 'Rôle « :label » supprimé.',
