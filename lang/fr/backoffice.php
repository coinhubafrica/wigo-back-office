...
return [
    ...
    'yango_sync' => [
        ...
        'period_hint' => 'La passe horaire ne regarde que la veille et le jour. Au-delà, ou en cas de trou, c\'est ici que la période se redemande.',
        'from' => 'Du',
        'to' => 'Au',
        ...
        'history_title' => 'Historique des journées',
        'history_hint' => 'Une ligne par journée : ce que le parc a fait, ce que le tableau de bord en a retenu, et où en est la dernière passe. « Tableau de bord » doit égaler « Terminées » — un écart signale un cumul non recompté.',
        'history_from' => 'Historique du',
        'history_to' => 'au',
        'reset_history' => 'Revenir aux 30 derniers jours',
        'column_day' => 'Journée',
        'column_completed' => 'Terminées',
        'column_cancelled' => 'Annulées',
        'column_dashboard' => 'Tableau de bord',
        'column_status' => 'État',
