...
enum BackOfficeModule: string
{
    ...
    /**
     * Le droit d'accès à ce module, tel qu'il est enregistré en base.
     *
     * Passe par `Permission` plutôt que de recomposer la chaîne : un module
     * ajouté sans son cas de permission lève ici, au premier appel, plutôt que
     * de rendre un 403 silencieux à tout le monde.
     */
    public function permission(): string
    {
        return $this->permissionEnum()->value;
    }

    public function permissionEnum(): Permission
    {
        return Permission::from("module.{$this->value}");
    }
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::YangoSync => 'Synchronisation',
    ...
    public function title(): string
    {
        return match ($this) {
            ...
            self::Drivers => 'Chauffeurs',
            self::Vehicles => 'Véhicules',
            self::YangoSync => 'Synchronisation Yango',
            self::SupportRequests => 'Requêtes',
            self::Challenges => 'Challenges',
            self::Recharges => 'Paiements',
            self::Cnps => 'CNPS (RSTI)',
            self::Users => 'Utilisateurs et rôles',
            self::Shop => 'Boutique',
            self::ShopOrders => 'Commandes',
            self::Announcements => 'Annonces',
            self::Campaigns => 'Campagnes',
    ...
    public function subtitle(): string
    {
        return match ($this) {
            ...
            self::Users => 'Comptes du back-office, rôles et droits — qui peut faire quoi',
            self::Settings => 'Barèmes, plafonds et clés API',
    ...
    public function eyebrow(): string
    {
        return match ($this) {
            ...
            self::Drivers, self::Vehicles, self::YangoSync => 'Parc',
            ...
            self::Users, self::Settings, self::Audit => 'Système',
        };
    }
    ...
    public function icon(): string
    {
        return match ($this) {
            ...
            self::YangoSync => 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 13.803-3.7M4.031 9.865a8.25 8.25 0 0 1 13.803-3.7l3.181 3.182m0-4.991v4.99',
