...
Verified in Chrome: the shop product form (trigger re-rendered → index path) and the challenges wizard (trigger survives → `isConnected` path). No test covers this — check it in a browser if you touch it.
